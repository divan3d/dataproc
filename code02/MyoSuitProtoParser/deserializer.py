...
from python_protos.v_1_0_0 import PSessionLogs_pb2
...
#############################
fld = r"C:\Users\wirth\polybox\MSc\Master Thesis\03_Relevant Files\03_Software\MyoSuit_Logs\S01_19112020_MS" # Folder where to look
fl2Use = "\S01_19112020_T03.myo" # File to decode
...
if save_pickle == 1:
    with open(fld + fl2Use.replace(".myo", ".pickle"), 'wb') as handle:
